        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div className="lg:w-1/2 space-y-6 md:space-y-8 text-center lg:text-left">
              ...
              >
                Fast & Error-Free <br />
                <span className="text-brand-600">POS Billing</span>
              </motion.h1>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <h2 className="text-sm font-black text-brand-600 uppercase tracking-[0.3em]">The Challenge</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              ...
              <div key={i} className="space-y-4 text-center">
                <div className="w-16 h-16 bg-slate-50 rounded-3xl flex items-center justify-center mx-auto text-slate-400 group-hover:text-brand-600 transition-colors">
      ...
      <section className="py-24 bg-slate-950 text-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20 space-y-4">
            <h2 className="text-sm font-black text-brand-600 uppercase tracking-[0.3em]">The Workflow</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-12 relative z-10">
              {[
                ...
                <div key={i} className="space-y-6 group">
                  <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-brand-600 font-black text-2xl group-hover:bg-brand-600 group-hover:text-white transition-all">
                    {item.step}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 space-y-4">
                <div className="text-4xl font-black text-brand-700">{item.val}</div>
